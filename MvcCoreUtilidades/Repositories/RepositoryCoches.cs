...
namespace MvcCoreUtilidades.Repositories
{
    public class RepositoryCoches
    {
            ...
            this.Cars = new List<Coche>
        {
            ...
            new Coche { IdCoche = 5, Marca = "DMG"
            , Modelo = "Deloread", Imagen = "https://www.topgear.es/sites/topgear.es/public/delorean-dmc-12-lateral.jpg"}
        };
        }
        ...
        {
            return
                this.Cars.FirstOrDefault(x => x.IdCoche == id);
        }
    }
}
